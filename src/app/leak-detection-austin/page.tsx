...
export const metadata = {
  title: `Leak Detection in ${CITY} | ${SITE_NAME}`,
  description: `Professional leak detection and repair in ${CITY}. Prevent water damage and save money. Call ${PHONE_NUMBER} for expert help.`,
};
  ...
  return (
    <>
      <section className="hero">
        ...
        <h1 className="text-3xl sm:text-4xl font-extrabold mb-2 text-blue-800 drop-shadow">Leak Detection in {CITY}</h1>
        <p className="text-lg text-blue-900 mb-4">Suspect a leak? Our specialists find and fix leaks fast. Protect your property from water damage.</p>
      ...
      <div className="callout">We find and repair slab leaks, hidden pipe leaks, and water line issues. Schedule a leak inspection today.</div>
