          ...
          <div className="max-w-4xl mx-auto flex items-center justify-between px-4 py-3">
            <div className="flex items-center gap-2">
              <a href="/" className="flex items-center gap-2 group">
                <img src="/logo.jpg" alt="Plumbers ATX logo" width={36} height={36} className="rounded" />
                <span className="text-2xl font-bold text-blue-900 tracking-tight group-hover:underline">Plumbers ATX</span>
              </a>
            </div>
