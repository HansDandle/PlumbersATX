...
export const metadata = {
  title: `Leak Detection Help in ${CITY} | ${SITE_NAME}`,
  description: `Caring help for leak worries in ${CITY}. We listen and connect you with local plumbers. Call ${PHONE_NUMBER} for gentle support.`,
};
  ...
  return (
    <>
      <section className="hero">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold mb-2 text-blue-900">Leak Detection Help in {CITY}</h1>
        <div className="flex flex-wrap gap-4 justify-center mb-4">
          <Image src="/undersink.jpeg" alt="Under sink pipes, gentle reassurance" width={320} height={180} className="rounded border bg-[#f7f6f3]" />
        </div>
        <p className="text-lg text-gray-800 mb-4">Worried about a leak? We listen and connect you with a local plumber who can help, day or night. No pressure, just support.</p>
      ...
      <div className="callout bg-[#f7f6f3] border rounded p-4 my-4 text-gray-800">We help you find the right local plumber for your leak problem. All work is performed by licensed professionals, not by this site.</div>
      <ul className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10">
        <li className="bg-[#f7f6f3] rounded border p-6 flex flex-col items-center text-center">
          ...
          <span className="font-bold text-lg mb-1">Slab leaks</span>
        </li>
        <li className="bg-[#f7f6f3] rounded border p-6 flex flex-col items-center text-center">
          <span className="text-2xl mb-1">🔎</span>
          <span className="font-bold text-lg mb-1">Hidden pipe leaks</span>
        </li>
        <li className="bg-[#f7f6f3] rounded border p-6 flex flex-col items-center text-center">
          <span className="text-2xl mb-1">🚰</span>
          <span className="font-bold text-lg mb-1">Water line repairs</span>
        </li>
      </ul>
